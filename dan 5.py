...
lable_5 = Label(root, text="Opis : ", width=20, bg='white', font=("bold", 10), fg='blue')
...
lable_unit = Label(root, text="Temparatura je v  stopinjah celzija in pritisk je v  mb", width=35, bg='white', font=("bold", 10),
                   fg='brown')
